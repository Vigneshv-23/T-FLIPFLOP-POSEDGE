...
```
module digi1( input clk, rst_n, input t,
output reg q,
output q_bar
);
always@(posedge clk) 
...
![image](https://github.com/Vigneshv-23/T-FLIPFLOP-POSEDGE/assets/110780412/4fef4be7-0b6e-4644-8a4c-53a4b0d91bce)

**TIMING DIGRAMS FOR FLIP FLOPS**
![image](https://github.com/Vigneshv-23/T-FLIPFLOP-POSEDGE/assets/110780412/a0455e7e-ac19-4e7f-923d-fc47247fef56)
